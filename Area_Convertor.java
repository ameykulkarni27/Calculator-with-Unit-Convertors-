...
public class Area_Convertor extends JPanel implements ActionListener {
	JLabel l1,l2;
	JComboBox cb1,cb2;
	double a,sqm;
	/**
	...
	public Area_Convertor() {
		...
		JLabel lblNewLabel = new JLabel("Area Convertor");
		...
		cb1.setModel(new DefaultComboBoxModel(new String[] {"Sq. Kilometer", "Sq. Meter", "Sq. Mile", "Sq. Yard", "Sq. Foot", "Acre", "Hectare", "Sq. Inch"}));
		...
		cb2.setModel(new DefaultComboBoxModel(new String[] {"Acre", "Sq. Kilometer", "Sq. Meter", "Sq. Mile", "Sq. Yard", "Sq. Foot", "Hectare", "Sq. Inch"}));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(cmd.equals("="))
		{
			...
			if(cb1.getSelectedItem().equals("Sq. Meter"))
				sqm=a;
			if(cb1.getSelectedItem().equals("Acre"))
				sqm=a*4046.9445569;
			if(cb1.getSelectedItem().equals("Sq. Kilometer"))
				sqm=a*1000000;
			if(cb1.getSelectedItem().equals("Sq. Mile"))
				sqm=a*2590002.59000259;
			if(cb1.getSelectedItem().equals("Sq. Yard"))
				sqm=a*0.8361274;
			if(cb1.getSelectedItem().equals("Sq. Foot"))
				sqm=a*0.0929030;
			if(cb1.getSelectedItem().equals("Hectare"))
				sqm=a*10000;
			if(cb1.getSelectedItem().equals("Sq. Inch"))
				sqm=a*0.00064516;
			if(cb2.getSelectedItem().equals("Sq. Meter"))
				l2.setText(String.valueOf(sqm));
			if(cb2.getSelectedItem().equals("Acre"))
				l2.setText(String.valueOf(sqm*0.0002471));
			if(cb2.getSelectedItem().equals("Sq. Kilometer"))
				l2.setText(String.valueOf(sqm*0.000001));
			if(cb2.getSelectedItem().equals("Sq. Mile"))
				l2.setText(String.valueOf(sqm*(3.861E-7)));
			if(cb2.getSelectedItem().equals("Sq. Yard"))
				l2.setText(String.valueOf(sqm*1.19599));
			if(cb2.getSelectedItem().equals("Sq. Foot"))
				l2.setText(String.valueOf(sqm*10.7639104));
			if(cb2.getSelectedItem().equals("Hectare"))
				l2.setText(String.valueOf(sqm*0.0001));
			if(cb2.getSelectedItem().equals("Sq. Inch"))
				l2.setText(String.valueOf(sqm*1550.0031));
		}
	}
}
