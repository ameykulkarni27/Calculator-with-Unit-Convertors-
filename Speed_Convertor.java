...
public class Speed_Convertor extends JPanel implements ActionListener {
	JLabel l1,l2;
	JComboBox cb1,cb2;
	double a,mps;
	/**
	...
	public Speed_Convertor() {
		...
		JLabel lblNewLabel = new JLabel("Speed Convertor");
		...
		cb1.setModel(new DefaultComboBoxModel(new String[] {"km/h", "Speed of Light", "Mile/hour", "km/s", "Mach", "Inch/s", "m/s"}));
		...
		cb2.setModel(new DefaultComboBoxModel(new String[] {"m/s", "km/h", "Speed of Light", "Mile/hour", "km/s", "Mach", "Inch/s"}));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(cmd.equals("="))
		{
			...
			if(cb1.getSelectedItem().equals("m/s"))
				mps=a;
			if(cb1.getSelectedItem().equals("km/h"))
				mps=a*0.27777778;
			if(cb1.getSelectedItem().equals("Speed of Light"))
				mps=a*299796138.6257345;
			if(cb1.getSelectedItem().equals("Mile/hour"))
				mps=a*0.44704;
			if(cb1.getSelectedItem().equals("km/s"))
				mps=a*1000;
			if(cb1.getSelectedItem().equals("Mach"))
				mps=a*340.2981011;
			if(cb1.getSelectedItem().equals("inch/s"))
				mps=a*0.02539999;
			if(cb2.getSelectedItem().equals("m/s"))
				l2.setText(String.valueOf(mps));
			if(cb2.getSelectedItem().equals("km/h"))
				l2.setText(String.valueOf(mps*3.6));
			if(cb2.getSelectedItem().equals("Speed of Light"))
				l2.setText(String.valueOf(mps*3.3356E-9));
			if(cb2.getSelectedItem().equals("Mile/hour"))
				l2.setText(String.valueOf(mps*2.236936));
			if(cb2.getSelectedItem().equals("km/s"))
				l2.setText(String.valueOf(mps*0.001));
			if(cb2.getSelectedItem().equals("Mach"))
				l2.setText(String.valueOf(mps*0.0029386));
			if(cb2.getSelectedItem().equals("inch/s"))
				l2.setText(String.valueOf(mps*39.370079));
