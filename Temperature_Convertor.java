...
public class Temperature_Convertor extends JPanel implements ActionListener {
	JLabel l1,l2;
	JComboBox cb1,cb2;
	double a,c;
	/**
	...
	public Temperature_Convertor() {
		...
		JLabel lblNewLabel = new JLabel("Temperture Convertor");
		...
		cb1.setModel(new DefaultComboBoxModel(new String[] {"Degree Celsius", "Degree Fahrenhiet", "Kelvin", "Degree Reaumur", "Degree Rankine"}));
		...
		cb2.setModel(new DefaultComboBoxModel(new String[] {"Degree Fahrenhiet", "Degree Celsius", "Kelvin", "Degree Reaumur", "Degree Rankine"}));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(cmd.equals("="))
		{
			...
			if(cb1.getSelectedItem().equals("Degree Celsius"))
				c=a;
			if(cb1.getSelectedItem().equals("Degree Fahrenhiet"))
				c=(0.55556*(a-32));
			if(cb1.getSelectedItem().equals("Kelvin"))
				c=a+273.15;
			if(cb1.getSelectedItem().equals("Degree Reaumur"))
				c=a/0.8;
			if(cb1.getSelectedItem().equals("Degree Rankine"))
				c=((a-491.67)*0.55556);
			if(cb2.getSelectedItem().equals("Degree Celsius"))
				l2.setText(String.valueOf(c));
			if(cb2.getSelectedItem().equals("Degree Fahrenhiet")) {
				a=c*1.8;
				l2.setText(String.valueOf(a+32));
			}
			if(cb2.getSelectedItem().equals("Kelvin"))
				l2.setText(String.valueOf(c+273.15));
			if(cb2.getSelectedItem().equals("Degree Reaumur"))
				l2.setText(String.valueOf(c*0.8));
			if(cb2.getSelectedItem().equals("Degree Rankine"))
				l2.setText(String.valueOf(c*1.8)+491.67);
