...
public class Volume_Convertor extends JPanel implements ActionListener {
	JLabel l1,l2;
	JComboBox cb1,cb2;
	double a,l;
	/**
	...
	public Volume_Convertor() {
		...
		cb1.setModel(new DefaultComboBoxModel(new String[] {"Litre", "Millilitre", "Cubic Meter", "Cubic Centimeter", "US fluid ounce", "UK gallon", "US gallon", "US fluid ounce"}));
		...
		cb2.setModel(new DefaultComboBoxModel(new String[] {"US gallon", "Litre", "Millilitre", "Cubic Meter", "Cubic Centimeter", "US fluid ounce", "UK gallon", "US fluid ounce"}));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(cmd.equals("="))
		{
			...
			if(cb1.getSelectedItem().equals("Litre"))
				l=a;
			if(cb1.getSelectedItem().equals("Millilitre"))
				l=a*0.001;
			if(cb1.getSelectedItem().equals("Cubic Meter"))
				l=a*1000;
			if(cb1.getSelectedItem().equals("Cubic Centimeter"))
				l=a*0.001;
			if(cb1.getSelectedItem().equals("US fluid ounce"))
				l=a*0.02927;
			if(cb1.getSelectedItem().equals("UK gallon"))
				l=a*4.546091;
			if(cb1.getSelectedItem().equals("US gallon"))
				l=a*3.785412;
			if(cb1.getSelectedItem().equals("US fluid ounce"))
				l=a*0.02841;
			if(cb2.getSelectedItem().equals("Litre"))
				l2.setText(String.valueOf(l));
			if(cb2.getSelectedItem().equals("Millilitre"))
				l2.setText(String.valueOf(l*1000));
			if(cb2.getSelectedItem().equals("Cubic Meter"))
				l2.setText(String.valueOf(l*0.001));
			if(cb2.getSelectedItem().equals("Cubic Centimeter"))
				l2.setText(String.valueOf(l*1000));
			if(cb2.getSelectedItem().equals("US fluid ounce"))
				l2.setText(String.valueOf(l*34.1646737));
			if(cb2.getSelectedItem().equals("UK gallon"))
				l2.setText(String.valueOf(l*0.2199692));
			if(cb2.getSelectedItem().equals("US gallon"))
				l2.setText(String.valueOf(l*0.2641721));
			if(cb2.getSelectedItem().equals("US fluid ounce"))
				l2.setText(String.valueOf(l*35.1988736));
