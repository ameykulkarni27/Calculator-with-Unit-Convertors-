...
public class Weight_Convertor extends JPanel implements ActionListener {
	JLabel l1,l2;
	JComboBox cb1,cb2;
	double a,kg;
	/**
	...
	public Weight_Convertor() {
		...
		cb1.setModel(new DefaultComboBoxModel(new String[] {"Kilogram", "Gram", "Quintal", "Carat", "Tonne", "Ounce", "Pound", "Stone"}));
		...
		cb2.setModel(new DefaultComboBoxModel(new String[] {"Pound", "Kilogram", "Gram", "Quintal", "Carat", "Tonne", "Ounce", "Stone"}));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(cmd.equals("="))
		{
			...
			if(cb1.getSelectedItem().equals("Kilogram"))
				kg=a;
			if(cb1.getSelectedItem().equals("Gram"))
				kg=a*0.001;
			if(cb1.getSelectedItem().equals("Quintal"))
				kg=a*100;
			if(cb1.getSelectedItem().equals("Carat"))
				kg=a*0.0002;
			if(cb1.getSelectedItem().equals("Tonne"))
				kg=a*1000;
			if(cb1.getSelectedItem().equals("Ounce"))
				kg=a*0.0283495;
			if(cb1.getSelectedItem().equals("Pound"))
				kg=a*0.4539237;
			if(cb1.getSelectedItem().equals("Stone"))
				kg=a*6.3502949;
			if(cb2.getSelectedItem().equals("Kilogram"))
				l2.setText(String.valueOf(kg));
			if(cb2.getSelectedItem().equals("Gram"))
				l2.setText(String.valueOf(kg*1000));
			if(cb2.getSelectedItem().equals("Quintal"))
				l2.setText(String.valueOf(kg*0.01));
			if(cb2.getSelectedItem().equals("Carat"))
				l2.setText(String.valueOf(kg*5000));
			if(cb2.getSelectedItem().equals("Tonne"))
				l2.setText(String.valueOf(kg*0.001));
			if(cb2.getSelectedItem().equals("Ounce"))
				l2.setText(String.valueOf(kg*35.2739619));
			if(cb2.getSelectedItem().equals("Pound"))
				l2.setText(String.valueOf(kg*2.2046226));
			if(cb2.getSelectedItem().equals("Stone"))
				l2.setText(String.valueOf(kg*0.157473));
